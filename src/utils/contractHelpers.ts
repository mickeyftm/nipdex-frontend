...
import gboneABI from 'config/abi/gbone.json'
...
export const getGboneContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(gboneABI, getGboneAddress(), signer)
}
export const getBoneContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(gboneABI, getBoneAddress(), signer)
}
...
export const getMasterchefContract = (type, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(masterChef, getMasterChefAddress(type), signer)
}
